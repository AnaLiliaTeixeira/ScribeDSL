 ...
 * </p>
 * <ul>
 *   <li>{@link scribedsl.impl.StopWordImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StopWordImpl extends MinimalEObjectImpl.Container implements StopWord {
	...
	protected EClass eStaticClass() {
		return ScribedslPackage.Literals.STOP_WORD;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScribedslPackage.STOP_WORD__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScribedslPackage.STOP_WORD__VALUE:
				return getValue();
		}
